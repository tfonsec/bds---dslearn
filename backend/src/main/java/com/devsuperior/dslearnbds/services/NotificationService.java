...
public class NotificationService  implements DeliverRevisionObserver {
	...
	public Page<NotificationDTO> notificationsForCurrentUser(boolean unreadOnly, Pageable pegealbe) {
		User user = authService.authenticated();
		Page<Notification> page = repository.find(user, unreadOnly, pegealbe);
